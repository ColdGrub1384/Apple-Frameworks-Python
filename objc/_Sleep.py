...
_HKSPQueueBackedScheduler = _Class('_HKSPQueueBackedScheduler')
HKSPXPCConnectionListener = _Class('HKSPXPCConnectionListener')
HKSPSleepEventTimeline = _Class('HKSPSleepEventTimeline')
_HKSPSleepEventTimelineAdjustment = _Class('_HKSPSleepEventTimelineAdjustment')
...
_HKSPObserverRecord = _Class('_HKSPObserverRecord')
...
_HKSPUserDefaultsStatePersistence = _Class('_HKSPUserDefaultsStatePersistence')
